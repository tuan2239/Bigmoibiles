<%-- 
    Document   : aboutus
    Created on : May 31, 2019, 2:37:41 PM
    Author     : congm
--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-last order-lg-first">
                            <div class="about-text-wrap">
                                ...
                                <p>We provide the best Products all over the world. We are the world best store in World for Products. You can buy our product without any hegitation because they truste us and buy our product without any hagitation because they belive and always happy buy our product.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="team-member mb-60 mb-sm-30 mb-xs-30">
                                <div class="team-thumb">
                                    <img src="uploadDir/1.png" alt="Our Team Member">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="team-member mb-60 mb-sm-30 mb-xs-30">
                                ...
                                <div class="team-content text-center">
                                    <h3>Tran Cong Minh</h3>
                                    <p>Member</p>
                                    <a href="#">congminhjr3@gmail.com</a>
                                    <div class="team-social">
                                        <a href="#"><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i></a>
                                        <a href="#"><i class="fa fa-linkedin"></i></a>
