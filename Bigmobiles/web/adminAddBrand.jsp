                            ...
                            <div class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form id="addBrandForm" action="InsertBrandServlet" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputBrandName" name="name" placeholder="Enter brand">
                                                </div>
