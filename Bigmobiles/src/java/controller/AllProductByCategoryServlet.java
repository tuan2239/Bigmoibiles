    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("ProHotList",listProHot);
             ...
             List<Products> ProductByCategory = productsFacade.AllProductByCategory(Categoryid);
            
            request.setAttribute("ProductByCategory", ProductByCategory);
            request.setAttribute("productListCount", productsFacade.AllProductByCategory(Categoryid).size())    ;
